...
1. You will need VS2015 installed to build this
...
1. Ensure that you have .NET Framework 4.5.2 or above
2. Copy the Build folder contents
3. If you don't already have VS2015 installed on the target, you will need to copy and register the MSDIA140.dll file using the following command line (run as Admin please):

	REGSVR32 <path to folder where you copied the tool\msdia140.dll>
